# This Makefile is intended *only* for building macOS binaries of Phidi.
...
app: $(APP_NAME)-native ## Create a Phidi.app
app-universal: $(APP_NAME)-universal ## Create a universal Phidi.app
$(APP_NAME)-%: $(TARGET)-%
	...
	xattr -c $(APP_DIR)/$(APP_NAME)/Contents/Resources/phidi.icns
...
dmg: $(DMG_NAME)-native ## Create a Phidi.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal Phidi.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
