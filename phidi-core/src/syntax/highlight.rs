...
use crate::{language::PhidiLanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<PhidiLanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
