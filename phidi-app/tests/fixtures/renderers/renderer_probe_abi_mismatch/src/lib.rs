...
use phidi_rpc::renderer::{RendererAbiVersion, RendererPluginDescriptorV1};

static PLUGIN_NAME: &[u8] = b"throwaway-abi-mismatch\0";
static PLUGIN_VERSION: &[u8] = b"0.1.0\0";
static HOST_API_REQUIREMENT: &[u8] = b">=0.1.0, <0.2.0\0";
