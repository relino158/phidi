...
pub struct PhidiColor {}

impl PhidiColor {
    pub const PHIDI_WARN: &'static str = "phidi.warn";
    pub const PHIDI_ERROR: &'static str = "phidi.error";
    pub const PHIDI_DROPDOWN_SHADOW: &'static str = "phidi.dropdown_shadow";
    pub const PHIDI_BORDER: &'static str = "phidi.border";
    pub const PHIDI_SCROLL_BAR: &'static str = "phidi.scroll_bar";

    pub const PHIDI_BUTTON_PRIMARY_BACKGROUND: &'static str =
        "phidi.button.primary.background";
    pub const PHIDI_BUTTON_PRIMARY_FOREGROUND: &'static str =
        "phidi.button.primary.foreground";

    pub const PHIDI_TAB_ACTIVE_BACKGROUND: &'static str =
        "phidi.tab.active.background";
    pub const PHIDI_TAB_ACTIVE_FOREGROUND: &'static str =
        "phidi.tab.active.foreground";
    pub const PHIDI_TAB_ACTIVE_UNDERLINE: &'static str =
        "phidi.tab.active.underline";

    pub const PHIDI_TAB_INACTIVE_BACKGROUND: &'static str =
        "phidi.tab.inactive.background";
    pub const PHIDI_TAB_INACTIVE_FOREGROUND: &'static str =
        "phidi.tab.inactive.foreground";
    pub const PHIDI_TAB_INACTIVE_UNDERLINE: &'static str =
        "phidi.tab.inactive.underline";

    pub const PHIDI_TAB_SEPARATOR: &'static str = "phidi.tab.separator";

    pub const PHIDI_ICON_ACTIVE: &'static str = "phidi.icon.active";
    pub const PHIDI_ICON_INACTIVE: &'static str = "phidi.icon.inactive";

    pub const PHIDI_REMOTE_ICON: &'static str = "phidi.remote.icon";
    pub const PHIDI_REMOTE_LOCAL: &'static str = "phidi.remote.local";
    pub const PHIDI_REMOTE_CONNECTED: &'static str = "phidi.remote.connected";
    pub const PHIDI_REMOTE_CONNECTING: &'static str = "phidi.remote.connecting";
    pub const PHIDI_REMOTE_DISCONNECTED: &'static str = "phidi.remote.disconnected";

    pub const PHIDI_PLUGIN_NAME: &'static str = "phidi.plugin.name";
    pub const PHIDI_PLUGIN_DESCRIPTION: &'static str = "phidi.plugin.description";
    pub const PHIDI_PLUGIN_AUTHOR: &'static str = "phidi.plugin.author";
