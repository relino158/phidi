    ...
    stack((
        h_stack((
            clickable_icon_base(
                move || {
                    if open.get() {
                        PhidiIcons::PANEL_FOLD_DOWN
                    } else {
                        PhidiIcons::PANEL_FOLD_UP
                    }
                },
                None::<Box<dyn Fn()>>,
                || false,
...
pub fn panel_container_view(
            ...
            .style(move |s| {
                ...
                s.absolute()
                    ...
                    .apply_if(is_dragging, |s| {
                        s.background(config.color(PhidiColor::EDITOR_CARET))
                            .apply_if(
    ...
    .style(move |s| {
        ...
        s.apply_if(!panel.is_container_shown(&position, true), |s| s.hide())
            ...
            .color(config.color(PhidiColor::PANEL_FOREGROUND))
    })
