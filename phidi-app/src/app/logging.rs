...
pub(super) fn logging() -> (Handle<Targets>, Option<WorkerGuard>) {
    ...
    let log_file_filter_targets = filter::Targets::new()
        .with_target("phidi_app", LevelFilter::DEBUG)
        .with_target("phidi_proxy", LevelFilter::DEBUG)
        .with_target("phidi_core", LevelFilter::DEBUG)
    ...
    let console_filter_targets = std::env::var("PHIDI_LOG")
        .unwrap_or_default()
