...
pub fn status(
    ...
    _config: ReadSignal<Arc<PhidiConfig>>,
) -> impl View {
        ...
        stack((
            ...
            .style(move |s| {
                ...
                let (bg, fg) = match mode.get() {
                    Mode::Normal => (
                        PhidiColor::STATUS_MODAL_NORMAL_BACKGROUND,
                        PhidiColor::STATUS_MODAL_NORMAL_FOREGROUND,
                    ),
                    Mode::Insert => (
                        PhidiColor::STATUS_MODAL_INSERT_BACKGROUND,
                        PhidiColor::STATUS_MODAL_INSERT_FOREGROUND,
                    ),
                    Mode::Visual(_) => (
                        PhidiColor::STATUS_MODAL_VISUAL_BACKGROUND,
                        PhidiColor::STATUS_MODAL_VISUAL_FOREGROUND,
                    ),
                    Mode::Terminal => (
                        PhidiColor::STATUS_MODAL_TERMINAL_BACKGROUND,
                        PhidiColor::STATUS_MODAL_TERMINAL_FOREGROUND,
                    ),
                };
            ...
            stack((
                svg(move || config.get().ui_svg(PhidiIcons::SCM)).style(move |s| {
                    let config = config.get();
                ...
                label(branch).style(move |s| {
                    s.margin_left(10.0)
                        .color(config.get().color(PhidiColor::STATUS_FOREGROUND))
                        .selectable(false)
                }),
            ))
            .style(move |s| {
            ...
            .on_event(
                ...
                move |_| {
                    if pointer_down.get() {
                        workbench_command
                            .send(PhidiWorkbenchCommand::PaletteSCMReferences);
                    }
                        ...
                        move |s| {
                            s.margin_left(5.0)
                                .color(
                                    config
                                        .get()
                                        .color(PhidiColor::STATUS_FOREGROUND),
                                )
                                .selectable(false)
                        },
                    ),
                    svg(move || config.get().ui_svg(PhidiIcons::WARNING)).style(
                        move |s| {
                            let config = config.get();
                            let size = config.ui.icon_size() as f32;
                            s.size(size, size)
        ...
        stack((
            {
                ...
                let icon = {
                    ...
                    move || {
                        ...
                        {
                            PhidiIcons::SIDEBAR_LEFT
                        } else {
                            PhidiIcons::SIDEBAR_LEFT_OFF
                        }
                    }
                };
                clickable_icon(
                ...
                let icon = {
                    ...
                    move || {
                        if panel.is_container_shown(
                            ...
                            PhidiIcons::LAYOUT_PANEL
                        } else {
                            PhidiIcons::LAYOUT_PANEL_OFF
                        }
                    }
                };
                clickable_icon(
            ...
            },
            {
                ...
                let icon = {
                    ...
                    move || {
                        ...
                        {
                            PhidiIcons::SIDEBAR_RIGHT
                        } else {
                            PhidiIcons::SIDEBAR_RIGHT_OFF
                        }
                    }
                };
                clickable_icon(
    ...
    .style(move |s| {
        ...
        s.border_top(1.0)
            ...
            .background(config.color(PhidiColor::STATUS_BACKGROUND))
...
fn status_text<S: std::fmt::Display + 'static>(
    ...
    label(text).style(move |s| {
        ...
        s.display(display)
            ...
            .padding_horiz(10.0)
            .items_center()
            .color(config.color(PhidiColor::STATUS_FOREGROUND))
            .hover(|s| {
